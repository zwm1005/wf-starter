 ...
 * @AuthorMr.WenMing
 */
public class AbstractAsyncTraceDispatcher extends AbstractAsyncDispatcher {
    ...
    private AbstractAsyncAppender appender;
    ...
    public AbstractAsyncTraceDispatcher(Properties properties) {
        int queueSize = Integer.parseInt(properties.getProperty(OnsTraceConstants.ASYNC_BUFFER_SIZE, "2048"));
         ...
         */
        this.notifyThreshold = Integer.parseInt(properties.getProperty(OnsTraceConstants.WAKE_UP_NUM, "1"));
    ...
    @Override
    public void start(AbstractAsyncAppender appender, String workerName) {
    ...
    class AsyncRunnable implements Runnable {
        @Override
        public void run() {
            final AbstractAsyncTraceDispatcher parent = AbstractAsyncTraceDispatcher.this;
                ...
                try {
                    ...
                    if (size > 0) {
                        ...
                        do {
                            ...
                            entries[idx] = null;
                            takeIndex.set(++take); // 单个消费者，无需用Mr.WenMingS
                            --size;
                            // 调用消费程序进行消费

package fun.werfamily.core.encrypt.common;
...
public class AES {
    ...
    public static void main(String[] args) {
        ...
        String info = "哈哈";
        String aesKey = "vaca!123456@2131";

        String ciphertext = AES.encryptToBase64(ConvertUtils.stringToHexString(info), aesKey);
        System.out.println(ciphertext);

        String plaintext = ConvertUtils.hexStringToString(AES.decryptFromBase64(ciphertext, aesKey));
